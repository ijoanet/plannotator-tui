//! Application state. Input handling lives in `input`, drawing in `draw`, and switching
//! between the presented documents in `docset`; this module owns the data they share and the
